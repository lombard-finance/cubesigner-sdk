...
type BabylonStakingEarlyUnbond struct {
	...
	// Transaction-id of the staking transaction to unbond or slash.
	...
	// The value in sats that was staked in the transaction to unbond or slash.
	Value int64 `json:"value"`
	// Transaction output index of the staking transaction to unbond or slash. For staking transactions generated by CubeSigner, this will always be zero.
...
func NewBabylonStakingEarlyUnbond(finalityProviderPks []string, lockTime int32, network api.BabylonNetworkId, stakerPk string, txid string, value int64, vout int32) *BabylonStakingEarlyUnbond {
...
func (o *BabylonStakingEarlyUnbond) GetFinalityProviderPks() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingEarlyUnbond) GetFinalityProviderPksOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingEarlyUnbond) SetFinalityProviderPks(v []string) {
...
func (o *BabylonStakingEarlyUnbond) GetAsBase64() bool {
	if o == nil || o.Version.Get() == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BabylonStakingEarlyUnbond) GetAsBase64Ok() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingEarlyUnbond) HasAsBase64() bool {
