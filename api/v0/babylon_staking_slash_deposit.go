...
// BabylonStakingSlashDeposit struct for BabylonStakingSlashDeposit
type BabylonStakingSlashDeposit struct {
...
// NewBabylonStakingSlashDeposit instantiates a new BabylonStakingSlashDeposit object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBabylonStakingSlashDeposit(finalityProviderPk string, lockTime int32, network api.BabylonNetworkId, stakerPk string, txid string, value int64, vout int32) *BabylonStakingSlashDeposit {
	this := BabylonStakingSlashDeposit{}
...
// NewBabylonStakingSlashDepositWithDefaults instantiates a new BabylonStakingSlashDeposit object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBabylonStakingSlashDepositWithDefaults() *BabylonStakingSlashDeposit {
	this := BabylonStakingSlashDeposit{}
	return &this
}
...
func (o *BabylonStakingSlashDeposit) GetExplicitParams() api.BabylonStakingParams {
...
func (o *BabylonStakingSlashDeposit) GetExplicitParamsOk() (*api.BabylonStakingParams, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingSlashDeposit) HasExplicitParams() bool {
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingSlashDeposit) GetFinalityProviderPkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingSlashDeposit) SetFinalityProviderPk(v string) {
	o.FinalityProviderPk = v
}

// GetLockTime returns the LockTime field value
func (o *BabylonStakingSlashDeposit) GetLockTime() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingSlashDeposit) GetLockTimeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingSlashDeposit) SetLockTime(v int32) {
	o.LockTime = v
}

// GetNetwork returns the Network field value
func (o *BabylonStakingSlashDeposit) GetNetwork() api.BabylonNetworkId {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingSlashDeposit) GetNetworkOk() (*api.BabylonNetworkId, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingSlashDeposit) SetNetwork(v api.BabylonNetworkId) {
	o.Network = v
}

// GetStakerPk returns the StakerPk field value
func (o *BabylonStakingSlashDeposit) GetStakerPk() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingSlashDeposit) GetStakerPkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingSlashDeposit) SetStakerPk(v string) {
	o.StakerPk = v
}

// GetVersion returns the Version field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BabylonStakingSlashDeposit) GetVersion() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BabylonStakingSlashDeposit) GetVersionOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingSlashDeposit) HasVersion() bool {
...
func (o *BabylonStakingSlashDeposit) SetVersion(v int32) {
	o.Version.Set(&v)
}

// SetVersionNil sets the value for Version to be an explicit nil
func (o *BabylonStakingSlashDeposit) SetVersionNil() {
	o.Version.Set(nil)
}

// UnsetVersion ensures that no value is present for Version, not even an explicit nil
func (o *BabylonStakingSlashDeposit) UnsetVersion() {
	o.Version.Unset()
}

// GetTxid returns the Txid field value
func (o *BabylonStakingSlashDeposit) GetTxid() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingSlashDeposit) GetTxidOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Txid, true
...
func (o *BabylonStakingSlashDeposit) SetTxid(v string) {
	o.Txid = v
}
...
func (o *BabylonStakingSlashDeposit) GetTxnLockHeight() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BabylonStakingSlashDeposit) GetTxnLockHeightOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BabylonStakingSlashDeposit) HasTxnLockHeight() bool {
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingSlashDeposit) GetValueOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Value, true
...
func (o *BabylonStakingSlashDeposit) SetValue(v int64) {
	o.Value = v
}

// GetVout returns the Vout field value
func (o *BabylonStakingSlashDeposit) GetVout() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BabylonStakingSlashDeposit) GetVoutOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Vout, true
...
func (o *BabylonStakingSlashDeposit) SetVout(v int32) {
	o.Vout = v
}

func (o BabylonStakingSlashDeposit) MarshalJSON() ([]byte, error) {
	return json.Marshal(o.Serialize())
}

func (o BabylonStakingSlashDeposit) Serialize() (toSerialize map[string]interface{}) {
...
type NullableBabylonStakingSlashDeposit struct {
	value *BabylonStakingSlashDeposit
	isSet bool
}

func (v NullableBabylonStakingSlashDeposit) Get() *BabylonStakingSlashDeposit {
	return v.value
}

func (v *NullableBabylonStakingSlashDeposit) Set(val *BabylonStakingSlashDeposit) {
	v.value = val
	v.isSet = true
}

func (v NullableBabylonStakingSlashDeposit) IsSet() bool {
	return v.isSet
}

func (v *NullableBabylonStakingSlashDeposit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBabylonStakingSlashDeposit(val *BabylonStakingSlashDeposit) *NullableBabylonStakingSlashDeposit {
	return &NullableBabylonStakingSlashDeposit{value: val, isSet: true}
}

func (v NullableBabylonStakingSlashDeposit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBabylonStakingSlashDeposit) UnmarshalJSON(src []byte) error {
	v.isSet = true
