...
func NewBabylonStakingWithdrawal(scriptData BabylonScriptData, fee int64, feeType FeeType, recipient string, txId string, value int64, vout int32, action BabylonStakingAction) *BabylonStakingWithdrawal {
...
func (o *BabylonStakingWithdrawal) GetAction() BabylonStakingAction {
	if o == nil {
		return ""
	}
	return o.Action
...
func (o *BabylonStakingWithdrawal) GetActionOk() (BabylonStakingAction, bool) {
	if o == nil {
		return "", false
	}
...
func (o *BabylonStakingWithdrawal) SetAction(v BabylonStakingAction) {
	o.Action = v
}
